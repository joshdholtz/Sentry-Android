...
Version | Changes
--- | ---
**1.4.2** | Fixes for a Google Play warning and added option to not use crash reporting (thanks to [ZeroStride](https://github.com/ZeroStride))
...
```
compile 'com.joshdholtz.sentry:sentry-android:1.4.2'
```
